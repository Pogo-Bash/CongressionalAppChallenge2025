...
function createD3FocusChart(chartElement, currentWeekData, previousWeekData) {
  ...
  // Set up axes
  const xAxis = d3.axisBottom(xScale).ticks(7).tickFormat(d3.timeFormat('%a')) // Short day name
  ...
  const currentLegend = legend.append('g').attr('class', 'legend-item')
